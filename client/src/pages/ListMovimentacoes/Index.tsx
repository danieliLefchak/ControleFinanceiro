import { Button, Card, CardBody, CardFooter, CardHeader, Heading, IconButton, Menu, MenuButton, MenuItem, MenuList, Table, TableContainer, Tbody, Td, Th, Thead, Tr } from "@chakra-ui/react";
import { BsChevronDown, BsPencilSquare, BsPlusCircle, BsPlusSlashMinus, BsTrash } from "react-icons/bs";
...
export function ListMovimentacoes(){
    ...
    const onDoMovimentation = (id: number, valMov: number, saldo: number, tpMov: String) => {
    ...
    return(
        <div className="container">
            <Card className="bg-light mb-3">
                <CardHeader className="fs-2 text-center">
                    Movimentações
                </CardHeader>
                                            ...
                                            <Td>
                                                <Menu>
                                                    ...
                                                    <MenuList>
                                                        <MenuItem 
                                                            icon={<BsPencilSquare />}
                                                            onClick={() => onEdit(`/movimentacoes/${movimentacao.id}`)}
                                                        >
                                                            Editar
                                                        </MenuItem>
                                                        <MenuItem 
                                                        ...
                                                        <MenuItem 
                                                            ...
                                                            onClick={() => onDoMovimentation(movimentacao.id!, movimentacao.valor, movimentacao.idConta.saldo, movimentacao.tipoMovimentacao)}
                                                        >
